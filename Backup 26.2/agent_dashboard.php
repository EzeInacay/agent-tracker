...
<div class="dashboard-container">
    ...
    <div class="booking-form-box">
        <h2>New Booking</h2>
<form class="booking-form" method="POST" action="submit_booking.php" onsubmit="return openSubmitModal(event)">
...
<script>
    ...
    let bookingForm; // store reference to the form

function openSubmitModal(event) {
    event.preventDefault(); // stop form from submitting
    bookingForm = event.target; // store form reference
