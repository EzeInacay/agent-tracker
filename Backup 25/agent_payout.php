...
// 📌 Weekly earnings
$sql = "SELECT SUM((b.final_price - b.ratehawk_price) * (b.commission_rate / 100)) as weekly
...
$sql = "SELECT SUM((b.final_price - b.ratehawk_price) * (b.commission_rate / 100)) as gross
        FROM booking_status bs
        INNER JOIN bookings b ON bs.booking_id = b.booking_id
        WHERE b.agent_id=? 
        AND bs.booking_status IN ('Confirmed','Completed')";
