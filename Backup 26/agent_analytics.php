...
$stats_res = $conn->query("
    SELECT COUNT(*) AS total_bookings, 
           SUM(published_rate - contracting_rate) AS total_earnings
    FROM bookings
...
$daily_res = $conn->query("
    SELECT DATE(bs.commission_date) AS day,
           SUM(b.published_rate - b.contracting_rate) AS earnings,
...
<div class="navbar">
    <div class="left">
        Welcome, <strong><?= htmlspecialchars($agentName) ?></strong>
    </div>
    <div class="right">
